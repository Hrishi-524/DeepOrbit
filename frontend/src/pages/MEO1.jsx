...
import { Satellite, ChevronDown, Loader, AlertTriangle } from 'lucide-react';

export default function MEO1() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900">
        <Loader className="w-8 h-8 text-green-600 dark:text-green-400 animate-spin mb-4" />
        <p className="text-gray-600 dark:text-gray-400">Loading MEO1 dataset results...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-6xl mx-auto px-6 py-8">
          <div className="flex items-start gap-4">
            <div className="w-14 h-14 bg-green-50 dark:bg-green-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
              <Satellite className="w-7 h-7 text-green-600 dark:text-green-400" />
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">MEO1 Dataset Results</h1>
                <span className="px-2 py-1 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 text-xs font-medium text-green-700 dark:text-green-300 rounded">
                  Medium Earth Orbit
                </span>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Prediction results for medium earth orbit satellites at 20,000 km altitude
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-6">
          ...
          <div className="relative inline-block w-full max-w-xs">
            <select 
              ...
              className="w-full appearance-none bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 pr-10 text-gray-900 dark:text-gray-100 font-medium focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent cursor-pointer"
            >
        ...
        {/* Residual Plots */}
        <div>
          <ResidualPlots dataset="MEO1" model={selectedModel} />
        </div>
      </div>
    </div>
  );
